    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, db_index=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('image', models.ImageField(height_field='height', upload_to=apps.posts.models.image.post_image_upload_to, width_field='width')),
            ...
            options={
                'ordering': ['id'],
                'indexes': [models.Index(fields=['post', 'id'], name='posts_posti_post_id_3169bd_idx')],
            },
        ),
        migrations.CreateModel(
